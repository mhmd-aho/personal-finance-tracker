...
urlpatterns = [
    ...
    path('transactions/profile/<str:profile_id>/monthly/', MonthlyTransactionListView.as_view(), name='transaction-monthly'),
    path('transactions/profile/<str:profile_id>/last-ten-days/', LastTenDaysTransactionListView.as_view(), name='transaction-ten-days'),
]